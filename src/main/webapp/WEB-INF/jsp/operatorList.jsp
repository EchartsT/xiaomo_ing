        ...
        <div class="collapse navbar-collapse" >
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="operatorList.html">操作流水记录</a></li>
                    </ul>
                </li>
                <li >
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <td><c:out value="${alog.fileName}"></c:out></td>
                    <td><a href="deleteop.html?operatorId=<c:out value="${alog.sernum}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
